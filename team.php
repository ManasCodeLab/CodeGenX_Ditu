...
<head>
    ...
    <title>CodeGenX - Leadership Team</title>
...
<body>
  ...
  <section class="section">
        <div class="department-section">
            <h2 class="department-title">Technical Team</h2>
            <div class="team-grid">
        ...
        <!-- Content Team -->
        <div class="department-section">
            <h2 class="department-title">Content Team</h2>
            <div class="team-grid">
                <div class="teams head">
                    <div class="member-image">
...
<!-- Design Team -->
<div class="department-section">
    <h2 class="department-title">Design Team</h2>
    <div class="team-grid">
        <div class="teams head">
            <div class="member-image">
...
<!-- Publicity Team -->
<div class="department-section">
    <h2 class="department-title">Publicity Team</h2>
    <div class="team-grid">
        <div class="teams head">
            <div class="member-image">
...
<div class="department-section">
            <h2 class="department-title">Management Team</h2>
            <div class="team-grid">
                <div class="teams head">
                    <div class="member-image">
...
<!-- Resource Team -->
<div class="department-section">
    <h2 class="department-title">Resource Team</h2>
    <div class="team-grid">
        <div class="teams head">
            <div class="member-image">
